...
public class Game {
    ...
    private char turn; // who's turn is it, 'o' or 'o' ? x always starts
    ...
    public String checkGameWinner(char [][]grid){
        ...
        //check x in diagonals
        if((grid[0][0] == 'x' && grid[1][1] == 'x' && grid[1][2] == 'x')||(grid[2][0] == 'x' && grid[1][1] == 'x' && grid[0][2] == 'x')){
            result = "X wins";
            win = true;
        }

        //check x horizontal and vertical
        ...
        //check o in diagonals
        if((grid[0][0] == 'o' && grid[1][1] == 'o' && grid[1][2] == 'o')||(grid[2][0] == 'o' && grid[1][1] == 'o' && grid[0][2] == 'o')){
            result = "O wins";
            win = true;
        }

        //check o horizontal and vertical
        for(int i = 0; i < grid.length; i++) {
